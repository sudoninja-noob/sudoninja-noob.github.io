...
l.innerHTML="";
d.items.forEach(i=>{
l.innerHTML+=`<div class="service-card"><h3>${i.title}</h3><p class="muted">${i.source} • ${i.date}</p><p><b>Matched:</b> ${i.tags.join(", ")}</p><a href="${i.url}" target="_blank" class="btn">View Source</a></div>`;
});
